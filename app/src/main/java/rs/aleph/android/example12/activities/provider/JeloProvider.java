...
public class JeloProvider {
    ...
    public static Jelo getJeloById(int id) {
        ...
        switch (id) {
            case 0:
                return new Jelo(0, "cevapi.jpg", "Cevapi", "Sarajevski cevapi sa lukom u domacem somunu.", rostilj, null, 1000, 750);
            case 1:
                return new Jelo(1, "karadjordjeva.jpeg", "Karadjordjeva", "Karadjordjeva snicla sa pomfritom i prilozima.", gotovoJelo, null, 1200, 1000);
            case 2:
                return new Jelo(2, "pizza.jpeg", "Pizza", "Pizza a la Italia", pizza, null, 1100, 600);
            default:
                return null;
        }
    }
